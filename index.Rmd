...
ggplot(filacompare, aes(x=rep, y=logstudies, color=type)) +facet_grid(study~., scales = "free") + geom_point(size=2) + theme_Publication() + ylab("Number of Studies") + xlab("Replication") + scale_color_manual(values=c("orange","blue"))

### Plot of Other studies
ggplot(othercompare, aes(x=rep, y=logstudies, color=type))  +facet_grid(study~., scales = "free") + geom_point(size=2) + theme_Publication() + ylab("Number of Studies") + xlab("Replication") + scale_color_manual(values=c("orange","blue"))
